...
extern const MIDL_SERVER_INFO WinGetServerManualActivation_ServerInfo;

extern const RPC_DISPATCH_TABLE WinGetServerManualActivation_v1_0_DispatchTable;

static const RPC_SERVER_INTERFACE WinGetServerManualActivation___RpcServerInterface =
    {
    sizeof(RPC_SERVER_INTERFACE),
    {{0x0ca09dda,0x857f,0x479f,{0xba,0x4b,0xda,0x87,0x5d,0x90,0x05,0x1e}},{1,0}},
    {{0x8A885D04,0x1CEB,0x11C9,{0x9F,0xE8,0x08,0x00,0x2B,0x10,0x48,0x60}},{2,0}},
    (RPC_DISPATCH_TABLE*)&WinGetServerManualActivation_v1_0_DispatchTable,
    0,
    0,
    0,
    &WinGetServerManualActivation_ServerInfo,
    0x06000000
    };
RPC_IF_HANDLE WinGetServerManualActivation_v1_0_s_ifspec = (RPC_IF_HANDLE)& WinGetServerManualActivation___RpcServerInterface;
...
static const RPC_DISPATCH_FUNCTION WinGetServerManualActivation_table[] =
    {
    NdrServerCall2,
    0
    };
static const RPC_DISPATCH_TABLE WinGetServerManualActivation_v1_0_DispatchTable = 
    {
    1,
    (RPC_DISPATCH_FUNCTION*)WinGetServerManualActivation_table
    };
...
static const MIDL_STUB_DESC WinGetServerManualActivation_StubDesc = 
    {
    (void *)& WinGetServerManualActivation___RpcServerInterface,
    MIDL_user_allocate,
    MIDL_user_free,
    0,
    0,
    ...
    0x2000001, /* MIDL flag */
    0, /* cs routines */
    (void *)& WinGetServerManualActivation_ServerInfo,   /* proxy/server info */
    0
    };

static const RPC_DISPATCH_FUNCTION WinGetServerManualActivation_NDR64__table[] =
    {
    NdrServerCallAll,
    0
    };
static const RPC_DISPATCH_TABLE WinGetServerManualActivation_NDR64__v1_0_DispatchTable = 
    {
    1,
    (RPC_DISPATCH_FUNCTION*)WinGetServerManualActivation_NDR64__table
    };
...
static const MIDL_SYNTAX_INFO WinGetServerManualActivation_SyntaxInfo [  2 ] = 
    ...
    ,{
    {{0x71710533,0xbeba,0x4937,{0x83,0x19,0xb5,0xdb,0xef,0x9c,0xcc,0x36}},{1,0}},
    (RPC_DISPATCH_TABLE*)&WinGetServerManualActivation_NDR64__v1_0_DispatchTable,
    0 ,
...
static const SERVER_ROUTINE WinGetServerManualActivation_ServerRoutineTable[] = 
    {
    (SERVER_ROUTINE)CreateInstance
    };

static const MIDL_SERVER_INFO WinGetServerManualActivation_ServerInfo = 
    {
    &WinGetServerManualActivation_StubDesc,
    WinGetServerManualActivation_ServerRoutineTable,
    WinGetServer__MIDL_ProcFormatString.Format,
    (unsigned short *) WinGetServerManualActivation_FormatStringOffsetTable,
    0,

...
namespace winrt::Microsoft::Management::Configuration::implementation
{
    ...
    void ConfigurationSetParser_0_2::ParseConfigurationUnit(ConfigurationUnit* unit, const Node& unitNode)
    {
        using namespace AppInstaller::Utility;

        CHECK_ERROR(ConfigurationSetParser_0_1::ParseConfigurationUnit(unit, unitNode));
